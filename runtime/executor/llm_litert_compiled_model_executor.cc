...
absl::Status LlmLiteRtCompiledModelExecutorBase::PrepareFirstPrefill(
...
absl::Status LlmLiteRtCompiledModelExecutorStatic::Prefill(
  ...
  LITERT_RETURN_IF_ERROR(PrepareFirstPrefill(kTokenIndexToReduce));
...
absl::Status LlmLiteRtCompiledModelExecutorDynamic::Prefill(
  ...
  LITERT_RETURN_IF_ERROR(PrepareFirstPrefill(0));
